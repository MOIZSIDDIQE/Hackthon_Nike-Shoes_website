...
const Navbar = () => {
    return (
        <nav className="">
            {/*first Navbar */}
            <div className="bg-[#F5F5F5] w-full h-12 flex items-center justify-center max-sm:text-sm ">
                <div className='h-9 w-11/12 flex items-center justify-between '>
            ...
            <div className="flex flex-col lg:flex-row  justify-between items-center  gap-5 lg:gap-0 py-3 px-4 md:px-8 lg:px-16 h-28 lg:h-20 w-full">

                <div className="flex  justify-between lg:justify-start items-center gap-28 xl:gap-56  w-full">
                    {/*logo */}
                    ...
                    {/*navigation */}
                    <div className="">
                        <ul className="flex gap-2 md:gap-5 justify-between">
                            <li className="">
                                <Link href="/ProductDetail" className=" text-xs md:text-sm lg:text-base text-nowrap">New & Features</Link>
                            </li>
                            <li className="">
                                <Link href="" className=" text-xs md:text-sm lg:text-base">Men</Link>
                            </li>
                            <li className="">
                                <Link href="" className=" text-xs md:text-sm lg:text-base">Women</Link>
                            </li>
                            <li className="">
                                <Link href="" className=" text-xs md:text-sm lg:text-base">Kids</Link>
                            </li>
                            <li className="">
                                <Link href="" className=" text-xs md:text-sm lg:text-base">Sale</Link>
                            </li>
                            <li className="">
                                <Link href="" className=" text-xs md:text-sm lg:text-base">SNKRS</Link>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                {/*search bar */}
                <div className="flex justify-between w-80 lg:w-96 gap">
                    <div className="flex bg-[#F5F5F5] rounded-full w-56 lg:w-48 p-2">
                        <Image className='mr-5' src="/Vector.svg" width={24} height={24} alt='Heart' />
                        <input type="search" placeholder='Search' className=' placeholder:text-gray-400 w-36 h-6 bg-transparent' />
                    </div>
