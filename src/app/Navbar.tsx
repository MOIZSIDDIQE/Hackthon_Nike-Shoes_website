...
const Navbar = () => {
    return (
        <nav className="">
            {/*first Navbar */}
            <div className="bg-[#F5F5F5] w-full h-12 flex items-center justify-center">
                <div className='h-9 w-11/12 flex items-center justify-between p-2'>
                    <div className=''>
            ...
            <div className="flex justify-between items-center py-3 px-16 h-20">
                ...
                <div className="ml-16">
                    <ul className="flex w-[420p] gap-5 justify-between">
                        ...
                        <li className="">
                            <Link href="" className="">SNKRS</Link>
                        </li>
                    </ul>
                </div>
